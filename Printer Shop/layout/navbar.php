...
<body>
  <nav class="navbar navbar-expand-lg bg-body-tertiary" id="navbar">
    <div class="container-fluid">
      <span>
        <a class="navbar-brand" href="index.php"><i class="fa-solid fa-cart-shopping-fast"></i><b>Printer Cang Daim</b></a>
        ...
        <div class="navbar-nav">
          <?php if (isset($_SESSION["username"])) : ?>
            <li class="nav-item dropdown">
              ...
              <a class="nav-link" href="transaksi.php"><i class="fa-solid fa-basket-shopping me-2"></i>Riwayat Transaksi</a>
